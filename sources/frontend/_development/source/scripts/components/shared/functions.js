...
class Functions {
    ...
    MobileOpenModal(_this) {
        ...
        var openModal = () => {
            ...
            $(_this.bussolaMainSelector + " #autocomplete")
                .val("")
                .focus();
            $("#autocomplete").click();
        };
    ...
    showAwesompletePreUl() {
        setTimeout(() => {
            ...
            $(this._awesompletePreUl)
                .css("height", ulHeight + 95 + "px")
                .removeAttr("hidden");
    ...
    setLabelCity() {
        ...
        var label = $(".label");
        var menuHeight = $(".comp_0001_header_control")
            .css("height")
            .split("px")[0];
