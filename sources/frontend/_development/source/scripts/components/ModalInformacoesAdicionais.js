            ...
            if(category === "anual"){
                ...
                $(".tab__content[data-main-content=3]").html(`
                    <ul>
                        ...
                        <li>
                            <a href="https://celular.vivo.com.br/planos/controle/regulamentos/Regulamento-Controle-Pernambuco-Anual.pdf" target="_blank">
            ...
            if(category === "mensal"){
                ...
                $(".tab__content[data-main-content=3]").html(`
                    <ul>
                        ...
                        <li>
                            <a href="https://celular.vivo.com.br/planos/controle/regulamentos/Regulamento-Controle-Pernambuco-Mensal.pdf" target="_blank">
                                Regulamento Controle
                            </a>
                        </li>
                    </ul>
