class ModalnformacoesAdicionais {
    ...
    setContent(critico) {
        if (critico === true) {
            ...
            <li>Incluiremos o regulamento do plano vigente como hiperlink <a href="https://www.vivo.com.br/portalweb/ShowPropertyServlet?nodeId=/UCMRepository/CONTRIB_138766&_ga=2.191488042.1447250500.1543240775-316014106.1543240775">https://www.vivo.com.br/</a> e demais hiperlinks serão adicionados posteriormente</li> 
            </ul>`)
            ...
            <li>A franquia de internet é válida pelo período de um mês;</li>
            <li>Após atingir o limite de dados do plano contratado, a internet será interrompida até a renovação do seu benefício, que é renovado mensalmente;</li>
            <li>As ligações são ilimitadas para chamadas locais e longa distância usando o código 15 para qualquer Vivo ou fixo;</li>
            <li>As ligações locais para celulares de outras operadoras são ilimitadas;</li>
            <li>As chamadas de longa distância com o código 15 para celulares de outras operadoras têm o valor de R$0,50/minuto;</li>
            </ul>`)
